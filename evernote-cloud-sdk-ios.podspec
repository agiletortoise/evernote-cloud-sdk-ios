Pod::Spec.new do |spec|
  ...
  spec.homepage = "https://github.com/agiletortoise/evernote-cloud-sdk-ios"
  spec.license = '  https://github.com/agiletortoise/evernote-cloud-sdk-ios/blob/master/LICENSE'
  spec.authors = { 'Evernote' => 'devsupport@evernote.com' }
  spec.source = { :git => "https://github.com/agiletortoise/evernote-cloud-sdk-ios.git", :tag => "2.0.6"}
